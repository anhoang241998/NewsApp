...
import com.annguyenhoang.newsapp.NewsApplication
import com.annguyenhoang.newsapp.models.Article
import com.annguyenhoang.newsapp.models.NewsResponse
...
class NewsViewModel(
    ...
    fun saveArticle(article: Article) = viewModelScope.launch(Dispatchers.Default) {
        newsRepository.upsert(article)
    }

    fun getSavedNews() = newsRepository.getSavedNews()

    fun deleteArticle(article: Article) = viewModelScope.launch(Dispatchers.Default) {
