...
import com.annguyenhoang.newsapp.databinding.FragmentSearchNewsBinding
import com.annguyenhoang.newsapp.ui.NewsActivity
import com.annguyenhoang.newsapp.ui.NewsViewModel
import com.annguyenhoang.newsapp.util.Constants
import com.annguyenhoang.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
        ...
        newsAdapter.registerAdapterDataObserver(object : RecyclerView.AdapterDataObserver() {
            override fun onItemRangeInserted(positionStart: Int, itemCount: Int) {
                ...
                if (viewModel.listState != null) {
                    binding.rvSearchNews.layoutManager?.onRestoreInstanceState(viewModel.listState)
                }
            }
        })
    }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        viewModel.listState = binding.rvSearchNews.layoutManager?.onSaveInstanceState()
        _binding = null
    }
}